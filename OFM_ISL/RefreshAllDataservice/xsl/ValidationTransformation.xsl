    ...
    <ns1:output>
      <ns1:MessageBody>
        <ns1:ErrorInformation>
          <xsl:choose>
            <xsl:when test="not (/ns1:input = &quot;QUERIES_DATA&quot; or /ns1:input = &quot;COMPOSITE_DATA&quot; or /ns1:input = &quot;ERROR_DATA&quot; or /ns1:input = &quot;MAPPING_DATA&quot; or /ns1:input = &quot;PARAMETER_DATA&quot; or /ns1:input = &quot;VALIDATION_DATA&quot; or /ns1:input = &quot;ALL&quot; )">
              <ns1:ErrorTechMessage>
                <xsl:text disable-output-escaping="no">Entry [ input ] has Invalid Value, Valid Values are [ QUERIES_DATA|COMPOSITE_DATA|ERROR_DATA|PARAMETER_DATA|VALIDATION_DATA|MAPPING_DATA|ALL ].</xsl:text>
              </ns1:ErrorTechMessage>
               <ns1:ErrorBusCode>
                <xsl:text disable-output-escaping="no">VF0001</xsl:text>
              </ns1:ErrorBusCode>
              <ns1:ErrorBusMessage>
                <xsl:text disable-output-escaping="no">Validation Fault : Unable to FulFill Transaction, Entry [ input ] has Invalid Value, Valid Values are [ QUERIES_DATA|COMPOSITE_DATA|ERROR_DATA|PARAMETER_DATA|VALIDATION_DATA|MAPPING_DATA|ALL ].</xsl:text>
              </ns1:ErrorBusMessage>
              <ns1:ErrorTechCode>
